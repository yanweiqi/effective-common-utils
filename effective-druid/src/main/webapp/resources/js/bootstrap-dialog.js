...
(function (root, factory) {
    ...
    BootstrapDialog.DEFAULT_TEXTS[BootstrapDialog.TYPE_DEFAULT] = '提示消息';
    BootstrapDialog.DEFAULT_TEXTS[BootstrapDialog.TYPE_INFO] = '提示消息';
    BootstrapDialog.DEFAULT_TEXTS[BootstrapDialog.TYPE_PRIMARY] = '提示消息';
    ...
    /**
     * Dialog Will close for a while (Create by Zhiguo)
     * @param message
     * @param type
     * @param millisecond
     * @returns {*}
     */
    BootstrapDialog.notify = function (message, type, millisecond) {
