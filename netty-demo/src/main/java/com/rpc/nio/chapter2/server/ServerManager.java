package com.rpc.nio.chapter2.server;


import com.rpc.nio.util.NamedThreadFactory;
...
public enum ServerManager {
	...
	private String counterFileName = "counterValue.txt";
	...
	public String startServer(String serverName, InetSocketAddress netSocketAddress) {
		logger.info(">>startServer(serverName=" + serverName + ",Internet SocketAddress=" + netSocketAddress + ")");
